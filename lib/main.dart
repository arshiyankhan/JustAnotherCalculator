...
class _HomeScreenState extends State<HomeScreen> {
        ...
        if (result.toString().endsWith(".0")){
          setState(() {
            ...
            if (forceUpdate){
              ...
              currentValue = "${result.toString().substring(0, result.toString().length - 2)}";
            }
            currentResult = "${result.toString().substring(0, result.toString().length - 2)}";
          });
        }else{
          setState(() {
  ...
  void keyBoardEventHandler(event){
    if(event is RawKeyDownEvent){
      ...
      else if (event.isKeyPressed(LogicalKeyboardKey.numpadEnter) || event.isKeyPressed(LogicalKeyboardKey.enter)){
          checkAndCalculateValue(forceUpdate: true);
        }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                FunctionButton(
                  text: "AC",
                  onPressed: (){handleButton("AC", isFunction:true);},
                ),
                FunctionButton(
                  text: "C",
                  onPressed: (){handleButton("C", isFunction:true);},
                ),
                FunctionButton(
                  text: "%",
                  size: 22,
                  onPressed: (){handleButton("%", isFunction:true);},
                ),
                FunctionButton(
                  text: "÷",
                  size: 28,
            ...
            Row(
              ...
              children: [
                NormalButton(
                  text: "7",
                  onPressed: (){handleButton("7");},
                ),
                NormalButton(
                  text: "8",
                  onPressed: (){handleButton("8");},
                ),
                NormalButton(
                  text: "9",
                  onPressed: (){handleButton("9");},
                ),
                FunctionButton(
                  text: "x",
                  size: 22,
                  onPressed: (){handleButton("x", isFunction:true);},
                ),
              ],
            ),
            SizedBox(height: 22,),
            Row(
              ...
              children: [
                NormalButton(
                  text: "4",
                  onPressed: (){handleButton("4");},
                ),
                NormalButton(
                  text: "5",
                  onPressed: (){handleButton("5");},
                ),
                NormalButton(
                  text: "6",
                  onPressed: (){handleButton("6");},
                ),
                FunctionButton(
                  text: "-",
                  size: 22,
            ...
            Row(
              ...
              children: [
                ...
                NormalButton(
                  text: "2",
                  onPressed: (){handleButton("2");},
                ),
                NormalButton(
                  text: "3",
                  onPressed: (){handleButton("3");},
                ),
                FunctionButton(
                  text: "+",
                  size: 22,
